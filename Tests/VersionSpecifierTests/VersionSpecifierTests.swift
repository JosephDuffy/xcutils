...
final class VersionSpecifierTests: XCTestCase {
    ...
    func testInitialiser() {
        ...
        XCTAssertEqual(VersionSpecifier(rawValue: "12-beta"), .exact(Version(12, 0, 0, prereleaseIdentifiers: ["beta"])))
        XCTAssertEqual(VersionSpecifier(rawValue: "12.1-beta"), .exact(Version(12, 1, 0, prereleaseIdentifiers: ["beta"])))
        XCTAssertEqual(VersionSpecifier(rawValue: "12.2.1-beta"), .exact(Version(12, 2, 1, prereleaseIdentifiers: ["beta"])))

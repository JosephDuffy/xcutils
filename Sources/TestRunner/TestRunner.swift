...
public final class TestRunner {
    ...
    public static func runTests(platform: Platform, scheme: String, project: String? = nil) throws {
        ...
        print("Looking for a simulators with runtime identifier", runtime.identifier)
